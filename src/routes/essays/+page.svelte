	...
	<div class="flex flex-col gap-3">
		{#each data.essays as essay, i}
			...
			>
				...
				<h2 class="text-primary group-hover:text-accent m-0 flex-1 text-[1.0625rem] font-medium transition-colors duration-[250ms] [transition-timing-function:var(--ease-out-expo)]">{essay.title}</h2>
