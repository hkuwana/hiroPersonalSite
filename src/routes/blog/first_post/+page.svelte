...
<div class="container w-full md:max-w-3xl mx-auto pt-20">
	...
	>
		...
		<p class="py-6">
			...
			> and miminal monochrome blog fan. This starter template provides a starting point to create your
			own minimal monochrome blog using Tailwind CSS and vanilla Javascript.
		</p>
