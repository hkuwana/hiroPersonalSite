...
<svelte:head>
	<title>Free ICS Validator & Fixer | Fix Broken Calendar Files Online</title>
	<meta
		name="description"
		content="Free online ICS validator and fixer. Auto-fixes missing VTIMEZONE, UID, DTSTAMP, and line folding for Google Calendar, Apple Calendar, and Outlook. Runs entirely in your browser. No upload, no signup."
	/>
	<meta name="keywords" content="ics validator, ics fixer, calendar file validator, ics file checker, fix ics file, google calendar import error, ical validator, vcalendar validator, RFC 5545 validator, broken ics file, AI generated ics fix" />
	...
	<meta property="og:title" content="Free ICS Validator & Fixer | Fix Broken Calendar Files Online" />
	<meta property="og:description" content="Validate and auto-fix .ics calendar files. Fixes missing timezones, UIDs, line folding. Works with Google Calendar, Apple Calendar, Outlook. Free, private, no signup." />
	<meta property="og:site_name" content="Hiro Kuwana" />

	<!-- Twitter -->
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content="Free ICS Validator & Fixer" />
	<meta name="twitter:description" content="Validate and auto-fix .ics calendar files. Fixes missing timezones, UIDs, line folding. Free, runs in your browser." />
	...
	<script type="application/ld+json">
		{JSON.stringify({
			...
			url: 'https://hirokuwana.com/ics-validator',
			description: 'Free online tool to validate and auto-fix .ics calendar files. Fixes missing VTIMEZONE, UID, DTSTAMP, line folding, and other RFC 5545 compliance issues for Google Calendar, Apple Calendar, and Outlook.',
			...
			featureList: [
				'Validate ICS/iCalendar files against RFC 5545',
				'Auto-fix missing VTIMEZONE components',
				'Auto-inject missing UID and DTSTAMP properties',
				'Fix line folding for Google Calendar compatibility',
				'Weekly calendar preview with timezone conversion',
	...
	<script type="application/ld+json">
		{JSON.stringify({
			...
			mainEntity: [
				{
					'@type': 'Question',
					name: 'How do I fix a broken ICS file?',
					acceptedAnswer: {
						'@type': 'Answer',
						text: 'Upload or paste your .ics file into the ICS Validator & Fixer at hirokuwana.com/ics-validator. It automatically detects and fixes common issues like missing VTIMEZONE, UID, DTSTAMP, and line folding problems that cause Google Calendar, Apple Calendar, or Outlook to reject the file.'
					}
				},
				{
					'@type': 'Question',
					name: 'Why does Google Calendar say "Import Failed" for my ICS file?',
					acceptedAnswer: {
						'@type': 'Answer',
						text: 'Google Calendar rejects ICS files that violate RFC 5545 standards. The most common causes are: lines longer than 75 characters (missing line folding), missing VTIMEZONE definitions, missing UID or DTSTAMP properties, and incorrect date formatting. The ICS Validator & Fixer can auto-fix all of these issues.'
					}
				},
				{
					'@type': 'Question',
					name: 'Is this ICS validator free and private?',
					acceptedAnswer: {
						'@type': 'Answer',
						text: 'Yes. The ICS Validator & Fixer is completely free with no signup required. All processing happens in your browser. Your calendar data is never uploaded to any server.'
					}
				},
				{
					'@type': 'Question',
					name: 'Can I fix ICS files generated by AI like ChatGPT or Claude?',
					acceptedAnswer: {
						'@type': 'Answer',
						text: 'Yes. AI-generated ICS files often have issues with RFC 5545 compliance, including missing UIDs, missing timezone definitions, and improper line folding. The ICS Validator & Fixer is specifically designed to catch and auto-fix these issues.'
					}
				}
			]
		})}
	...
	<script type="application/ld+json">
		{JSON.stringify({
			...
			itemListElement: [
				...
				{ '@type': 'ListItem', position: 3, name: 'ICS Validator & Fixer', item: 'https://hirokuwana.com/ics-validator' }
			]
		})}
	</script>
