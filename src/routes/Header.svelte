...
<header>
	<div class="grid pt-9">
		<div class="flex justify-center mb-9">
			<a href="https://www.facebook.com/hiro.kuwana.1/" target="_blank" class="mr-9 text-gray-800">
				<svg
					aria-hidden="true"
					focusable="false"
					data-prefix="fab"
			...
			<a href="#!" target="_blank" class="mr-9 text-gray-800">
				<svg
					aria-hidden="true"
					focusable="false"
					data-prefix="fab"
			...
			<a href="https://github.com/hkuwana" target="_blank" class="text-gray-800">
				<svg
					aria-hidden="true"
					focusable="false"
					data-prefix="fab"
